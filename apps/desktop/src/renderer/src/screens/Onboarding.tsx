...
import { Bot, Key, Settings, CheckCircle2, ChevronRight, Loader2, AlertTriangle } from 'lucide-react';
            ...
            case 0:
                return (
                    <div className="flex flex-col items-center space-y-4 text-center mt-4 w-full">
                        ...
                        <p className="text-gray-500 max-w-xs">The premier platform for comparing and testing AI models side-by-side. Let's get your workspace set up.</p>
                        <button
                            onClick={handleNext}
                    ...
                    <div className="flex flex-col items-center space-y-4 w-full mt-4">
                        ...
                        <div className="w-full space-y-3">
                            ...
                            {detectProviderFromKey(apiKey) === 'nvidia_nim' && (
                                <div className="text-sm text-yellow-600 dark:text-yellow-500 font-medium bg-yellow-50 dark:bg-yellow-500/10 p-2 rounded flex items-start gap-2">
                                    ...
                                    <span>
                                        This looks like an NVIDIA NIM key (nvapi-). To use NVIDIA NIM, skip this step and connect via the NVIDIA NIM connector in the app.
                                    </span>
                                </div>
                            )}
                        ...
                        <div className="flex space-x-3 w-full mt-4">
                            ...
                            <button
                                ...
                                disabled={isVerifying || !apiKey.trim() || detectProviderFromKey(apiKey) === 'nvidia_nim'}
            ...
            case 2:
                return (
                    <div className="flex flex-col items-center space-y-4 text-center mt-4 w-full">
                        ...
                        <p className="text-sm text-gray-500 text-center mb-2">Configure your defaults. You can change these later in Settings.</p>
                        ...
                        <div className="w-full bg-background border border-border rounded-xl p-4 flex items-center justify-between">
                            ...
                            <span className="text-xs text-gray-400 bg-black/5 dark:bg-white/5 px-2 py-1 rounded">System Default</span>
                        </div>
            ...
            default:
                return (
                    <div className="flex flex-col items-center space-y-4 text-center mt-4 w-full">
                        ...
                        <p className="text-gray-500">Your workspace is ready. Start discovering and testing AI models.</p>
                        <button
                            onClick={handleNext}
